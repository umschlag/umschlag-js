...
* @alias module:umschlag/ApiClient
* @class
*/
class ApiClient {
  constructor () {
  ...
  /**
    ...
    * @param {module:umschlag/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:umschlag/ApiClient}
*/
